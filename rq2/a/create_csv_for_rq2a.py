...
def main():
    ...
    dataset_1 = Dataset.load_from_file("./study_data/full_study/results/0.8_percent_e386/carla_rsv/test_fail.json", 
        "./study_data/full_study/full_study_data", 
        "./study_data/full_study/full_study_data")
    dataset_2 = Dataset.load_from_file("./study_data/full_study/results/0.8_percent_e386/carla_rsv/train.json", 
        "./study_data/full_study/full_study_data", 
        "./study_data/full_study/full_study_data")
